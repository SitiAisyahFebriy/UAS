...
switch ($nama_faskes) {
    ...
    // update data ke database
    $input = "UPDATE data_pendaftar set nama_pendaftar='$nama',kelamin='$jk',tgl_lahir='$tgl_lahir',umur='$umur',alamat='$alamat',no_hp='$no_hp',wilayah='$prov',nama_faskes='$nm_faskes' WHERE nik=$nik";
